...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Inject.Activities.MapActivity, Inject, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MapActivity.class, __md_methods);
	}
	...
	public MapActivity ()
	{
		...
		if (getClass () == MapActivity.class)
			mono.android.TypeManager.Activate ("Inject.Activities.MapActivity, Inject, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
